...
namespace BananasAndPeaches.Controllers
{
    public class ToolsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,name,description,alreadyGot,supplier,cost")] Tool tool)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,name,description,alreadyGot,supplier,cost")] Tool tool)
        {
            if (ModelState.IsValid)
            {
